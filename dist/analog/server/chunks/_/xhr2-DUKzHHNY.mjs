import { c as commonjsGlobal, g as getDefaultExportFromCjs } from './renderer.mjs';
...
var xhr2$2 = { exports: {} };
(function() {
  var InvalidStateError, NetworkError, ProgressEvent, SecurityError, SyntaxError, XMLHttpRequest, XMLHttpRequestEventTarget, XMLHttpRequestUpload, http, https, url;
  ...
  XMLHttpRequest = function() {
    ...
    XMLHttpRequest2.prototype._userAgent = `Mozilla/5.0 (${""} ${""}) node.js/${"node"} v8/${"v8"}`;
    return XMLHttpRequest2;
  }.call(this);
  xhr2$2.exports = XMLHttpRequest;
...
var xhr2Exports = xhr2$2.exports;
const xhr2 = /* @__PURE__ */ getDefaultExportFromCjs(xhr2Exports);
const xhr2$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: xhr2
}, Symbol.toStringTag, { value: "Module" }));

export { xhr2$1 as x };
//# sourceMappingURL=xhr2-DUKzHHNY.mjs.map
