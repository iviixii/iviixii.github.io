...
<p>If you want to learn more about NgFor, I recommend you look at its\xA0source code. We&#39;ll proceed to look at the <code>context</code> object.</p>
<pre class="language-ts"><code class="language-ts"><span class="token comment">/**
 * @publicApi
 */</span>
...
<p>We will improve our custom &quot;*exchangeRate&quot; directive in the following (and possibly final?) article of this series so that it can work with the micro-syntax with ease. Additionally, instead of re-rendering the template after each successful API call, we will expose the response as an\xA0observable to our template.</p>
`;

export { _20230213MasteringAngularStructuralDirectivesMicroSyntaxInTheWild as default };
//# sourceMappingURL=2023-02-13-mastering-angular-structural-directives-micro-syntax-in-the-wild-C0yX-_7f.mjs.map
